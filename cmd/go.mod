module github.com/oarkflow/search/cmd

go 1.22.3

replace github.com/oarkflow/search => ../

require github.com/oarkflow/search v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/oarkflow/filters v0.0.16 // indirect
